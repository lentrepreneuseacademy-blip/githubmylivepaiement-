...
export default function SuperAdminPage() {
  ...
  if (!user || user.email !== 'contact@mylivepaiement.com') return <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: sf, background: '#0A0A0A' }}><span style={{ color: '#333' }}>Acces refuse</span></div>
